Contributing to the NetuitiveD
======================================
...
### Reporting Bugs
Report bugs on [the issues page](https://github.com/Netuitive/netuitived/issues).
...
### Fixing bugs
Find bugs at [the issues page](https://github.com/Netuitive/netuitived/issues). Anything tagged with
...
Find features at [the issues page](https://github.com/Netuitive/netuitived/issues). Anything tagged
...
NetuitiveD can always use documentation (more documentation is always better!). 
...
### Submitting Feedback
File an issue at [the issues page](https://github.com/Netuitive/netuitived/issues).
